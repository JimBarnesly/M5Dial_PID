...
constexpr uint32_t WIFI_BOOT_CONNECT_DELAY_MS = 30000;
...
constexpr uint16_t DEFAULT_CONTROLLER_LOSS_GRACE_SEC = 5;
constexpr uint16_t DEFAULT_WARMUP_TIMEOUT_MINUTES = 20;
constexpr uint16_t DEFAULT_MAX_CONTINUOUS_HEAT_MINUTES = 45;
...
constexpr uint32_t ALARM_STARTUP_INHIBIT_MS = 120000;
constexpr uint32_t ALARM_RECONNECT_INHIBIT_MS = 45000;
constexpr uint32_t ALARM_AUTOTUNE_RECOVERY_MS = 90000;
constexpr uint32_t SENSOR_STALE_MS = 10000;
constexpr float MAX_REASONABLE_CALIBRATION_OFFSET_C = 8.0f;
...
constexpr uint8_t ALARM_HISTORY_CAPACITY = 16;
constexpr char FIRMWARE_VERSION[] = "v0.9.0-dev";
constexpr bool DEFAULT_TESTING_MODE_ENABLED = true;
